...
elections1 = dash.Dash(__name__,
                server=server,
                url_base_pathname='/elections1/',
                csrf_protect=False)
...
# elections1.config.include_asset_files = True
#
# elections1.css.append_css("my.css")

# chris's css
elections1.css.append_css({"external_url": "https://codepen.io/chriddyp/pen/bWLwgP.css"})
# my and typography.css from S3 bucket
elections1.css.append_css({"external_url": s3_css_mycss})
# elections1.css.append_css({"external_url": s3_css_typography})
...
@elections1.callback(Output('tabs-content-inline', 'children'),
...
if __name__ == '__main__':
	elections1.run_server(debug=True)